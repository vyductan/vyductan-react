...
export function TypingPerfPlugin(): JSX.Element | null {
  ...
  useEffect(() => {
    ...
    globalThis.addEventListener("selectionchange", measureEventEnd, true);
    globalThis.addEventListener("beforeinput", beforeInputHandler, true);
    globalThis.addEventListener("paste", pasteHandler, true);
    globalThis.addEventListener("cut", cutHandler, true);

    return () => {
      globalThis.removeEventListener("keydown", keyDownHandler, true);
      globalThis.removeEventListener("selectionchange", measureEventEnd, true);
      globalThis.removeEventListener("beforeinput", beforeInputHandler, true);
      globalThis.removeEventListener("paste", pasteHandler, true);
      globalThis.removeEventListener("cut", cutHandler, true);
    };
  }, [report]);

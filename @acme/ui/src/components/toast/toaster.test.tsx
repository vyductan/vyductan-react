...
import type { ToasterProps as SonnerToasterProperties } from "sonner";
...
type MockSonnerProperties = {
  className?: string;
  toastOptions?: SonnerToasterProperties["toastOptions"];
};

vi.mock("@acme/ui/shadcn/sonner", async () => {
  const React = await import("react");

  const MockSonner = React.forwardRef<HTMLDivElement, MockSonnerProperties>(
    ({ className, toastOptions }, reference) => {

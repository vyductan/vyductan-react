...
const Dragger = ({
  ...
  const [preview, setPreview] = useState<string | undefined>(fileProperty?.url);
  ...
  function handleFileChange(file: File) {
    ...
    if (showZoneOnly && fileInputReference.current) {
    ...
    <>
      ...
      >
        {preview && showUploadList ? (
          ...
          <div>{children(fileInputReference, reset)}</div>
        ) : (
          <div
            className={cn(
...
export type { DraggerProperties as DraggerProps };
export { Dragger };

...
export type GlobalToken = GlobalTokenTypeUtility<ComponentTokenMap, AliasToken>;

export type OverrideToken = OverrideTokenTypeUtility<
  ComponentTokenMap,
  AliasToken
>;

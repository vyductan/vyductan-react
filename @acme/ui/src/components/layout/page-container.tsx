...
import type { PageContentProps as PageContentProperties } from "./page-content";
import type { PageHeaderProps as PageHeaderProperties } from "./page-header";
...
export type PageContainerProps = {
  ...
  exception?: PageContentProperties["exception"];
  fluid?: boolean;
};

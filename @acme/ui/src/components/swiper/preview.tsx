  ...
  return (
    <AnimatePresence>
      {activeIndex >= 0 && (
        ...
        >
          <div className="absolute top-0 right-6 z-10 flex h-12 items-center justify-between text-white">
            <div></div>
            ...
            >
              {images.map((imgProperties) => (
                <SwiperSlide>
                  ...
                  >
                    <picture>
                      <img alt="swiper preview" {...imgProperties} />
                    </picture>
                  </div>
                </SwiperSlide>
              ))}
            ...
            >
              {images.map((imgProperties) => (
                <SwiperSlide className="h-[100px] w-auto! cursor-pointer rounded-md border border-white p-1 opacity-40">
                  ...
                  >
                    <picture>
                      <img alt="swiper thumb" {...imgProperties} />
                    </picture>
                  </div>
                </SwiperSlide>
              ))}

...
const CardContent = ({
  ...
  return (
    <ShadcnCardContent
      className={cn(
        "p-4 pt-0 peer-[.border-b]/card-header:pt-4 first:pt-4",
        size === "small" &&
          "p-3 pt-0 peer-[.border-b]/card-header:pt-3 first:pt-3",
        className,
      )}
      {...properties}
    />
...
const CardFooter = ({
  ...
  return (
    <ShadcnCardFooter
      className={cn(
        "bg-muted/50 rounded-b-xl border-t p-4 group-data-[size=small]/card:p-3 [.border-t]:pt-4",

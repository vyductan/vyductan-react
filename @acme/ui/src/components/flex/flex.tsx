...
interface FlexProperties extends React.HTMLAttributes<HTMLDivElement> {
  /**
...
const Flex = ({
  ...
  inline = false,
  ...properties
}: FlexProperties & { ref?: React.Ref<HTMLDivElement> }) => {
  ...
  return (
    <div className={classes} style={mergedStyle} {...properties}>
      {children}
    </div>
  );
};
...
export { Flex };
export type { FlexProperties as FlexProps };

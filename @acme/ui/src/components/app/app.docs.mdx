---
title: App
description: A global context component for imperative UI operations like modals, messages, and notifications.
component: true
---
...
> Note: The warning dialog hides the Cancel button and emphasizes the OK button with warning styling.
...
| `modal.warning(config)` | Show a warning dialog (OK only) | `ConfirmConfig` |
...
```tsx
import type { ConfirmConfig } from "@acme/ui";
import { App } from "@acme/ui";

...
import AvatarOptionsExample from "./examples/avatar-options.mdx";
...
import OptionLabelPropExample from "./examples/option-label-prop.mdx";
...
<AvatarOptionsExample />

<OptionLabelPropExample />

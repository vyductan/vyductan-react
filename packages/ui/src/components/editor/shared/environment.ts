...
const domWindow: (Window & typeof globalThis) | undefined = CAN_USE_DOM
...
export const CAN_USE_BEFORE_INPUT = !!(
  domWindow &&
  "InputEvent" in domWindow &&
  !documentMode &&
  "getTargetRanges" in new domWindow.InputEvent("input")
);
...
export const IS_IOS: boolean =
  ...
  !(domWindow && "MSStream" in domWindow && domWindow.MSStream);

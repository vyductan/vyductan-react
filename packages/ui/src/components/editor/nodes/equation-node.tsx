...
function $convertEquationElement(
  ...
  let equation = domNode.dataset.lexicalEquation;
  const inline = domNode.dataset.lexicalInline === "true";
...
export class EquationNode extends DecoratorNode<JSX.Element> {
  ...
  exportDOM(): DOMExportOutput {
    ...
    element.dataset.lexicalEquation = equation;
    element.dataset.lexicalInline = `${this.__inline}`;
  ...
  static importDOM(): DOMConversionMap | null {
    return {
      div: (domNode: HTMLElement) => {
        if (!Object.hasOwn(domNode.dataset, "lexicalEquation")) {
          return null;
        }
        return {

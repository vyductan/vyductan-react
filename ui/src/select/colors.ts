export const selectColors: Record<string, string> = {
  ...
  fuchsia:
    "bg-fuchsia-200 text-fuchsia-900 border-fuchsia-900 hover:border-fuchsia-500 focus-within:border-fuchsia-600 focus-within:ring-fuchsia-100",
  green:

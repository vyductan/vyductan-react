---
title: TimePicker
description: A time input component with native browser support and custom visual picker.
component: true
---
...
```tsx
<TimePicker className="w-32" size="lg" placeholder="Pick a time" />
```
...
```tsx
<TimePicker className="w-24 border-gray-300 text-sm focus:border-blue-500" />
```

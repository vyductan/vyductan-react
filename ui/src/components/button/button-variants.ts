  ...
  compoundVariants: [
    ...
    },
    {
      ...
      className: [
        ...
        "hover:border-teal-400 hover:bg-teal-400",
        "active:border-teal-600 active:bg-teal-600",
      ],
    },
    {
      variant: "solid",
    ...
    },
    {
      ...
      className: [
        ...
        "active:border-amber-600 active:bg-amber-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "hover:border-yellow-400 hover:bg-yellow-400",
        "active:border-yellow-600 active:bg-yellow-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "hover:border-lime-400 hover:bg-lime-400",
        "active:border-lime-600 active:bg-lime-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "active:border-sky-600 active:bg-sky-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "hover:border-violet-400 hover:bg-violet-400",
        "active:border-violet-600 active:bg-violet-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "hover:border-fuchsia-400 hover:bg-fuchsia-400",
        "active:border-fuchsia-600 active:bg-fuchsia-600",
      ],
    },
    {
      variant: "solid",
      ...
      className: [
        ...
        "hover:border-rose-400 hover:bg-rose-400",
        "active:border-rose-600 active:bg-rose-600",
      ],
    },
    // outlined
    {
    ...
    },
    {
      ...
      className: [
        ...
        "active:border-gray-600 active:text-gray-600",
      ],
    },
    {
      variant: "outlined",
    ...
    },
    {
      ...
      className: [
        ...
        "active:border-amber-600 active:text-amber-600",
      ],
    },
    {
      variant: "outlined",
    ...
    },
    {
      ...
      className: [
        ...
        "active:border-lime-600 active:text-lime-600",
      ],
    },
    {
      variant: "outlined",
      ...
      className: [
        ...
        "active:border-sky-600 active:text-sky-600",
      ],
    },
    {
      variant: "outlined",
    ...
    },
    {
      ...
      className: [
        ...
        "active:border-fuchsia-600 active:text-fuchsia-600",
      ],
    },
    {
      variant: "outlined",
      ...
      className: [
        ...
        "active:border-rose-600 active:text-rose-600",
      ],
    },
    // filled | light
    {
    ...
    },
    {
      ...
      className: [
        ...
        "hover:bg-lime-200 hover:text-lime-700",
      ],
    },
    {
      variant: "filled",
    ...
    },
    {
      ...
      className: [
        ...
        "hover:bg-fuchsia-200 hover:text-fuchsia-700",
      ],
    },
    {
      variant: "filled",
      ...
      className: [
        ...
        "hover:bg-rose-200 hover:text-rose-700",
      ],
    },
    // Text
    {
    ...
    },
    {
      ...
      className: [
        ...
        "active:bg-teal-200 active:text-teal-600",
      ],
    },
    {
      variant: "text",
    ...
    },
    {
      ...
      className: [
        "text-orange-500",
        "hover:bg-orange-50 hover:text-orange-400",
        "active:bg-orange-200 active:text-orange-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        ...
        "active:bg-amber-200 active:text-amber-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        "text-yellow-500",
        "hover:bg-yellow-50 hover:text-yellow-400",
        "active:bg-yellow-200 active:text-yellow-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        "text-lime-500",
        "hover:bg-lime-50 hover:text-lime-400",
        "active:bg-lime-200 active:text-lime-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        "text-sky-500",
        "hover:bg-sky-50 hover:text-sky-400",
    ...
    },
    {
      ...
      className: [
        "text-violet-500",
        "hover:bg-violet-50 hover:text-violet-400",
        "active:bg-violet-200 active:text-violet-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        "text-fuchsia-500",
        "hover:bg-fuchsia-50 hover:text-fuchsia-400",
        "active:bg-fuchsia-200 active:text-fuchsia-600",
      ],
    },
    {
      variant: "text",
      ...
      className: [
        "text-rose-500",
        "hover:bg-rose-50 hover:text-rose-400",
        "active:bg-rose-200 active:text-rose-600",
      ],
    },

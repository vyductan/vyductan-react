---
title: Modal
description: A flexible dialog component with declarative and imperative usage patterns.
component: true
---
...
### Warning Dialog (AntD-style)

`Modal.warning` is available through the App context and renders a single OK button with a warning icon.
...
- This dialog hides the Cancel button and styles the OK button with an amber accent.
...
```tsx
<Modal open={open} title="Wide Modal" width={800} onOpenChange={setOpen}>
